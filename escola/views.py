...
from escola.serializers import EstudanteSerializer, CursoSerializer, MatriculaSerializer, ListMatriculasCursoSerializer, ListMatriculasEstudanteSerializer, EstudanteSerializerV2
...
class ListaMatriculaCurso(generics.ListAPIView):
    ...
    serializer_class = ListMatriculasCursoSerializer